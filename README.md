...
Экспорт создаёт модель только для паттернов с формой входа [4, 40] и выхода [4, 64, 24, 24]. Исходный датасет не хранится в репозитории и загружается сценарием при необходимости.
